...
latex_documents = [
    (master_doc, "PennyLane-Cirq.tex", "PennyLane-Cirq Documentation", "Xanadu Inc.", "manual"),
]
...
man_pages = [(master_doc, "PennyLane-Cirq", "PennyLane-Cirq Documentation", [author], 1)]
